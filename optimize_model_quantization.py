...
def main(path_img, path_models="models"):
    ...
    Args:
        ...
        path_models (str): Path to the directory containing images for calibration.
    """
    ...
    # Save the models
    torch.save(model_dynamic_quantized.state_dict(), os.path.join(path_models,'quantized_model.pth'))
    torch.save(model.state_dict(), os.path.join(path_models,'non_quantized_model.pth'))
    torch.save(model_dynamic_quantized, os.path.join(path_models,'quantized_model_full.pth'))
    torch.save(model, os.path.join(path_models,'non_quantized_model_full.pth'))
